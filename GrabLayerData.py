...
def train():
    ...
    cb = [early_stopping, ExtractIntermediateOutputs(cifar10_model, epochs_to_extract, layer_names, x_train, save_location, directory), WandbMetricsLogger(log_freq=5), WandbModelCheckpoint("models")]
